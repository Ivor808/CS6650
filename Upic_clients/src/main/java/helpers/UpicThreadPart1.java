...
public class UpicThreadPart1 implements Runnable {
  ...
  public UpicThreadPart1(Integer startSkier, Integer endSkier, Integer startTime,
      Integer endTime,Integer liftId, long numRequestsToSend, ApiClient apiClient, CountPart1 count, CountDownLatch latch) {
  ...
  public UpicThreadPart1(Integer startSkier, Integer endSkier, Integer startTime,
      Integer endTime,Integer liftId, long numRequestsToSend, ApiClient apiClient, CountPart1 count, CountDownLatch latch, CountDownLatch phase2End) {
    this.startSkier = startSkier;
    this.endSkier = endSkier;
    this.startTime = startTime;
    this.endTime = endTime;
