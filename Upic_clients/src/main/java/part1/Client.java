...
import helpers.CountPart1;
import helpers.ResponseRecord;
import helpers.UpicThreadPart1;
...
public class Client {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    client.setBasePath("http://18.206.147.82:8080/Upic_war/");
    ...
    for (int i = 0; i < numThreads; i++) {
      UpicThreadPart1 thread = new UpicThreadPart1(idStart, idStart + phase2SkierIdRange, startTime, endTime
